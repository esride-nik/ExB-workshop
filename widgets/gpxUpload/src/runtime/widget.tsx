import { React, type AllWidgetProps, FormattedMessage, DataSourceComponent, type FeatureLayerQueryParams, DataSourceManager, DataSourceStatus, type DataRecord, type FeatureLayerDataSource } from 'jimu-core'
